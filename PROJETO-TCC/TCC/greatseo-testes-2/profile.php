...
<form id="formDadosAluno" name="formDadosAluno" method="post" action="publication.php" enctype="multipart/form-data">
    ...
    <div class="container">
        <div class="panel panel-primary">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <ul>
                        <li>Categoria ACC:</li> <input type="text" class="form-control" name="ACC" id="ACC" value="<?php echo $valor18; ?>" > 
                        <li>Categoria A:</li> <input type="text" class="form-control" name="A" id="A" value="<?php echo $valor13; ?>"> 
                        <li>Categoria B:</li> <input type="text" class="form-control" name="B" id="B" value="<?php echo $valor14; ?>">  
                        <li>Categoria C:</li> <input type="text" class="form-control" name="C" id="C" value="<?php echo $valor15; ?>"> 
                        <li>Categoria D:</li> <input type="text" class="form-control" name="D" id="D" value="<?php echo $valor16; ?>">  
                        <li>Categoria E:</li> <input type="text" class="form-control" name="E" id="E" value="<?php echo $valor17; ?>">   
                    </ul>          
                </div>
                <div class="col-md-4">
        ...
        if (valor == 'simE' && !status) {
            ...
            <div class="col-md-6"> 
                <input id="btnAtualizarDados" name="btnAtualizarDados" type="submit" class="btn btn-primary btn-sm" style="width:190px;height:40px;font-size:15px;background-color: #000;" onclick="AtualizarDados()" value="Atualizar Dados"> 
            </div>
    </div>
</form>
